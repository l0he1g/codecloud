Ext.onReady(function(){
	...
	//同keywords1.js的修改是一样的
	var weekUrl="../../controller/getPhases.php?type=week";	
	var monthUrl="../../controller/getPhases.php?type=month";
	var daydataUrl="../../controller/processWebsiteCate.php?operation=1";
	var domainUrl="../../controller/processWebsiteCate.php?operation=2";
	var hostUrl="../../controller/processWebsiteCate.php?operation=3";
	var urlUrl="../../controller/processWebsiteCate.php?operation=4";
	var useridUrl="../../controller/processWebsiteCate.php?operation=5";
...
//组装面板
	...
	var centerPanel=new Ext.Panel({
		...
		,tbar:new Ext.ux.dateToolbar({
			...
			,queryItemId:'cate'	//查询textfield id
			,queryItemName:'cate'	//查询textfield name
			,buttonText:'确定'	//查询按钮文字
			,params:{'cate':$('#cateParams').val()}	//附加查询参数
			,selectQueryEnabled:true	//选择时间下拉框后即触发相应事件
			,items:['查询关键字:','<span style="color:#15428B;font-weight:bold;">'+$('#cateParams').val()+'</span>','-']
			//uid导出参数
