<?php
   ...
   * 返回数据格式:
   *返回数据格式：
   {'success':true,rows:[{daydata:[{date:'2009-10-13',visits_num:13,uid_num:13:ip_num:13},......],topdomain:[{domain:'',rate:13},......],tophost:[{host:'',rate:13},......],topurl:[{url:'',rate:13},......],topuserid:[{userid:'',rate:13},......]}]}
